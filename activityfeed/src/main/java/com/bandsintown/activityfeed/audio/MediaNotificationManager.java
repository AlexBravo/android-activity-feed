    ...
    private final MediaControllerCompat.Callback mMediaControllerCallback = new MediaControllerCompat.Callback() {
        ...
        public void onSessionDestroyed() {
            ...
            try {
                ...
                Print.log("could not connect media controller");
                Print.exception(e);
            }
        }
    };
...
//            mContext.stopForeground(true);
    ...
    private void fetchBitmapFromURLAsync(final String bitmapUrl, final NotificationCompat.Builder builder) {
        ...
        BitImgProvider.with(mContext).source(bitmapUrl).fetch(new OnActionCompleteListener<Bitmap>() {
            ...
            public void onComplete(Bitmap data) {
                if(data != null && mMetadata != null && mMetadata.getDescription().getIconUri() != null
                    ...
                    Print.log(TAG, "fetchBitmapFromURLAsync: set bitmap to ", bitmapUrl);
